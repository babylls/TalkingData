...
gender_age_test_brand_device<-merge(as.data.frame(gender_age_test),as.data.frame(phone_brand_device_model),by='device_id',all.x=T,all.y=F)
...
bayesian_test_data<-merge(gender_age_test_brand_device,makemodel_bayesian,by.x='makemodel',by.y='makemodel',all.x=T)
